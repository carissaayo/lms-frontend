...
import { StatsCard } from "@/components/analytics/admin/StatCard";
      ...
      <main className="space-y-8 mb-10 p-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          <StatsCard
            ...
            change={`${analytics?.overview?.activeCourses || 0} active`}
            icon={BookOpen}
            trend="up"
            color="green"
          />
          <StatsCard
            ...
            value={analytics?.overview?.totalInstructors || 0}
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          <StatsCard
            ...
            value={analytics?.overview?.activeStudents?.toLocaleString() || 0}
            change={`${((analytics?.overview?.activeStudents / analytics?.overview?.totalStudents) * 100).toFixed(1)}% of total`}
            icon={Activity}
            trend="up"
            color="orange"
          />
          <StatsCard
            ...
            value={analytics?.overview?.totalWithdrawals?.toLocaleString() || 0}
          ...
          <StatsCard
            ...
            value={`${analytics?.engagementMetrics?.studentRetentionRate || 0}%`}
