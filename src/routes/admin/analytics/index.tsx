...
function RouteComponent() {
  ...
  const isForbidden = useAuthStore((state) => state.isForbidden);
          ...
          <main className="space-y-8 mb-10 p-8">
            ...
            {!isLoading && !isForbidden && (
              <>
                ...
                <TopInstructorsAndTopCourses
                  topCourses={analytics.topCourses}
                  topInstructors={analytics.topInstructors}
                />

                {/* Engagement Metrics & Withdrawal Reasons */}
                <EngagementMetricsCon
                  engagementMetrics={analytics.engagementMetrics}
                  recentWithdrawals={analytics.recentWithdrawals}
                />
